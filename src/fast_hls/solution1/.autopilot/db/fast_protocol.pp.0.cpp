...
# 2 "<built-in>" 2
# 1 "fast_src/fast_protocol.cpp" 2
# 1 "fast_src/fast_protocol.h" 1
...
#pragma pack(pop)
# 10 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 2 3
...
extern "C" {
# 26 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
  struct _iobuf {
    char *_ptr;
    int _cnt;
    char *_base;
...
# 80 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 81 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 2 3
...
# 506 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 761 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wshadow"
...
# 1061 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 1105 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 1186 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 1200 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 1228 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 2 3
# 1237 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 1335 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
int __attribute__((__cdecl__)) __mingw_str_wide_utf8 (const wchar_t * const wptr, char **mbptr, size_t * buflen);
# 1349 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
int __attribute__((__cdecl__)) __mingw_str_utf8_wide (const char *const mbptr, wchar_t ** wptr, size_t * buflen);
# 1358 "C:/Xilinx/Vitis/2024.2/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
const ap_uint<48> MY_MAC_ADDR = 0xE59D02350A00;
const ap_uint<48> BROADCAST_MAC = 0xFFFFFFFFFFFF;
...
# 83 "fast_src/fast_protocol.h"
typedef ap_fixed<16, 8> fix16;
...
__attribute__((sdx_kernel("fast_protocol", 0))) void fast_protocol(stream<axiWord>& lbRxDataIn,
...
# 2 "fast_src/fast_protocol.cpp" 2
# 1 "fast_src/fast_decoder.h" 1
# 10 "fast_src/fast_decoder.h"
class Fast_Decoder
{
...
private:
    ...
    static void decode_decimal_to_fix16(uint8 encoded_message[16],
                                        unsigned & message_offset,
                                        fix16 & decoded_fix16);

    static void decode_uint_to_uint32(uint8 encoded_message[16],
                                      unsigned & message_offset,
                                      uint32 & decoded_uint32);

    static void decode_uint_to_uint8(uint8 encoded_message[16],
                                     unsigned & message_offset,
                                     uint8 & decoded_uint8);

    static void decode_uint_to_uint2(uint8 encoded_message[16],
                                     unsigned message_offset,
                                     uint3 & decoded_uint2);

};
# 3 "fast_src/fast_protocol.cpp" 2
# 1 "fast_src/fast_encoder.h" 1
...
private:
    ...
    static void encode_decimal_from_fix16(fix16 & decoded_fix16,
                                          ...
                                          uint8 encoded_message[16]);

    static void encode_signed_int(uint8 encoded_message[16],
                                  unsigned & mantissa_offset,
                                  mantissa_t mantissa);
...
# 4 "fast_src/fast_protocol.cpp" 2
# 16 "fast_src/fast_protocol.cpp"
...
#pragma HLS PIPELINE II=1
 ...
 static enum Rx_State
    ...
    static ap_uint<8> encoded_message[16] = { 0. };
...
#pragma HLS ARRAY_PARTITION variable=encoded_message complete dim=1
 ...
 static ap_uint<64> first_packet = 0;
    ...
    case PORT_OPEN:
        ...
        {
            lbRequestPortOpenOut.write(641);
    ...
    case FUNC:
        if (true)
        {
            ...
            uint8 encoded_message[16] = { 0. };
#pragma HLS ARRAY_PARTITION variable=encoded_message complete dim=1

 VITIS_LOOP_119_1: for (unsigned i = 0; i < 64/8; i++)
            {
                encoded_message[i] = first_packet >> (8 * i);
                encoded_message[i + 64/8] = second_packet >> (8 * i);
            }
            ...
            if ((encoded_message[message_offset] & 0x80) != 0x80)
            {
                decoded_mantissa = (decoded_mantissa << 7)
            ...
            decoded_mantissa = (decoded_mantissa << 7)
                    | (encoded_message[message_offset++] & 0x7F);
...
# 177 "fast_src/fast_protocol.cpp"
            if ((encoded_message[message_offset] & 0x80) != 0x80)
            {
                size_buff = (size_buff << 7)
                        | (encoded_message[message_offset++]);
            }
            ...
            VITIS_LOOP_192_2: for (unsigned i = 0; i < 4; i++)
            {
                if ((encoded_message[message_offset] & 0x80) == 0x80)
                {
                    break;
                }
                orderID_buff = (orderID_buff << 7)
                        | (encoded_message[message_offset++]);
            }
            ...
            order_type_buff = (encoded_message[message_offset] & 0x7F);
...
#pragma HLS ARRAY_PARTITION variable=encoded_message complete dim=1
 ...
 VITIS_LOOP_242_3: for (unsigned i = 0; i < 64/8; i++)
            {
                encoded_message[i] = first_packet >> (8 * i);
                encoded_message[i + 64/8] = second_packet >> (8 * i);
            }
            ...
            price_buff = decoded_mantissa * POW10[-decoded_exponent];
# 295 "fast_src/fast_protocol.cpp"
            if ((encoded_message[message_offset] & 0x80) != 0x80)
            {
                size_buff = (size_buff << 7)
                        | (encoded_message[message_offset++]);
            ...
            VITIS_LOOP_310_4: for (unsigned i = 0; i < 4; i++)
            {
                if ((encoded_message[message_offset] & 0x80) == 0x80)
                {
                    break;
 ...
 static enum Tx_State
    ...
    case READ:
                ...
                && !lbTxLengthOut.full() && !tagsOut.full())
        {
            ...
            ap_uint<8> encoded_message[16] = { 0. };
#pragma HLS ARRAY_PARTITION variable=encoded_message complete dim=1

 encoded_message[0] = 0xFC;
            encoded_message[1] = 0x81;
            encoded_message[2] = 0x80;
            encoded_message[3] = 0x81;
            ...
            VITIS_LOOP_409_1: for (unsigned i = 0; i < max_bytes_need_for_uint32 - 1; i++)
            {
            ...
            VITIS_LOOP_429_2: for (int i = 64/8 - 1; i >= 0; i--)
            {
                first_packet_data = (first_packet_data << 8)
                        | encoded_message[i];
                second_packet_data = (second_packet_data << 8)
                        | encoded_message[i + 64/8];
            }
# 445 "fast_src/fast_protocol.cpp"
...
__attribute__((sdx_kernel("fast_protocol", 0))) void fast_protocol(stream<axiWord>& lbRxDataIn,
                   ...
                   stream<order> &order_from_book)
{
#line 16 "C:/Users/ruuud/spring2025/cse145/WORKINGPROJECTIDEA/HFT_PYNQZ1-Z2/src/build_fast_core_fixed.tcl"
