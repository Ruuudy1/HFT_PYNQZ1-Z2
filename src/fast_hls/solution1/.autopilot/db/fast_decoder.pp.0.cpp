...
#pragma HLS ARRAY_PARTITION variable=encoded_message complete dim=1
 ...
 VITIS_LOOP_26_1: for (unsigned i = 0; i < 64/8; i++)
    {
...
# 80 "fast_src/fast_decoder.cpp"
    ...
    VITIS_LOOP_95_2: for (unsigned i = 0; i < 4; i++)
    {
        if ((encoded_message[message_offset] & 0x80) == 0x80)
        {
            break;
...
# 129 "fast_src/fast_decoder.cpp"
void Fast_Decoder::decode_decimal_to_fix16(uint8 encoded_message[16],
                                           unsigned & message_offset,
                                           fix16 & decoded_fix16)
{
# 143 "fast_src/fast_decoder.cpp"
static const fix16 POW10_DEC8[8] = {
    ...
    if ((encoded_message[message_offset] & 0x40) == 0x40)
    {
        decoded_exponent = -1;
    }


    VITIS_LOOP_166_1: for (unsigned i = 0; i < 2; i++)
    {
        if ((encoded_message[message_offset] & 0x80) == 0x80)
        {
            break;
        }
        decoded_exponent = (decoded_exponent << 7)
                | (encoded_message[message_offset++]);
    }
    ...
    VITIS_LOOP_192_2: for (unsigned i = 0; i < 6; i++)
    {
        if ((encoded_message[message_offset] & 0x80) == 0x80)
        {
            break;
...
# 233 "fast_src/fast_decoder.cpp"
void Fast_Decoder::decode_uint_to_uint8(uint8 encoded_message[16],
                                        unsigned & message_offset,
                                        uint8 & decoded_uint8)
{

    VITIS_LOOP_238_1: for (unsigned i = 0; i < 2; i++)
    {
        if ((encoded_message[message_offset] & 0x80) == 0x80)
        {
            break;
        }
        decoded_uint8 = (decoded_uint8 << 7)
                | (encoded_message[message_offset++]);
    }
...
void Fast_Decoder::decode_uint_to_uint32(uint8 encoded_message[16],
                                         unsigned & message_offset,
                                         uint32 & decoded_uint32)
{


    VITIS_LOOP_259_1: for (unsigned i = 0; i < 5; i++)
    {
        if ((encoded_message[message_offset] & 0x80) == 0x80)
        {
            break;
        }
        decoded_uint32 = (decoded_uint32 << 7)
                | (encoded_message[message_offset++]);
    }
...
void Fast_Decoder::decode_uint_to_uint2(uint8 encoded_message[16],
                                        unsigned message_offset,
                                        uint3 & decoded_uint2)
{
    decoded_uint2 = (encoded_message[message_offset] & 0x7F);
}
