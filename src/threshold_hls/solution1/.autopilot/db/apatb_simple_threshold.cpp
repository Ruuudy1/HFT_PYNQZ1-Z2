...
// wrapc file define:
#define AUTOTB_TVIN_top_bid "../tv/cdatafile/c.simple_threshold.autotvin_top_bid.dat"
#define WRAPC_STREAM_SIZE_IN_top_bid "../tv/stream_size/stream_size_in_top_bid.dat"
#define WRAPC_STREAM_INGRESS_STATUS_top_bid "../tv/stream_size/stream_ingress_status_top_bid.dat"
#define AUTOTB_TVIN_top_ask "../tv/cdatafile/c.simple_threshold.autotvin_top_ask.dat"
#define WRAPC_STREAM_SIZE_IN_top_ask "../tv/stream_size/stream_size_in_top_ask.dat"
#define WRAPC_STREAM_INGRESS_STATUS_top_ask "../tv/stream_size/stream_ingress_status_top_ask.dat"
#define AUTOTB_TVIN_incoming_time "../tv/cdatafile/c.simple_threshold.autotvin_incoming_time.dat"
...
#define AUTOTB_TVIN_incoming_meta "../tv/cdatafile/c.simple_threshold.autotvin_incoming_meta.dat"
...
#define AUTOTB_TVOUT_outgoing_order "../tv/cdatafile/c.simple_threshold.autotvout_outgoing_order.dat"
#define WRAPC_STREAM_SIZE_OUT_outgoing_order "../tv/stream_size/stream_size_out_outgoing_order.dat"
#define WRAPC_STREAM_EGRESS_STATUS_outgoing_order "../tv/stream_size/stream_egress_status_outgoing_order.dat"
#define AUTOTB_TVOUT_outgoing_time "../tv/cdatafile/c.simple_threshold.autotvout_outgoing_time.dat"
...
#define AUTOTB_TVOUT_outgoing_meta "../tv/cdatafile/c.simple_threshold.autotvout_outgoing_meta.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_outgoing_order "../tv/rtldatafile/rtl.simple_threshold.autotvout_outgoing_order.dat"
#define AUTOTB_TVOUT_PC_outgoing_time "../tv/rtldatafile/rtl.simple_threshold.autotvout_outgoing_time.dat"
#define AUTOTB_TVOUT_PC_outgoing_meta "../tv/rtldatafile/rtl.simple_threshold.autotvout_outgoing_meta.dat"
...
extern "C"
void simple_threshold_hw_stub_wrapper(void*, void*, void*, void*, void*, void*, void*);

extern "C"
void apatb_simple_threshold_hw(void* __xlx_apatb_param_top_bid, void* __xlx_apatb_param_top_ask, void* __xlx_apatb_param_incoming_time, void* __xlx_apatb_param_incoming_meta, void* __xlx_apatb_param_outgoing_order, void* __xlx_apatb_param_outgoing_time, void* __xlx_apatb_param_outgoing_meta)
{
  static hls::sim::Stream<hls::sim::Byte<12>> port0 {
    .width = 96,
    .name = "top_bid",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_top_bid),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_top_bid),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_top_bid),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_top_bid),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<12>>*)__xlx_apatb_param_top_bid;
  ...
  static hls::sim::Stream<hls::sim::Byte<8>> port1 {
    ...
    .name = "top_ask",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_top_ask),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_top_ask),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_top_ask),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_top_ask),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_top_ask;
  ...
  port2.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_incoming_time;
  ...
  port3.param = (hls::stream<hls::sim::Byte<16>>*)__xlx_apatb_param_incoming_meta;
  ...
  static hls::sim::Stream<hls::sim::Byte<8>> port4 {
    ...
    .name = "outgoing_order",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_outgoing_order),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_outgoing_order),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_outgoing_order),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_outgoing_order),
#endif
  };
  port4.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_outgoing_order;
  port4.hasWrite = true;
  ...
  try {
    ...
    simple_threshold_hw_stub_wrapper(__xlx_apatb_param_top_bid, __xlx_apatb_param_top_ask, __xlx_apatb_param_incoming_time, __xlx_apatb_param_incoming_meta, __xlx_apatb_param_outgoing_order, __xlx_apatb_param_outgoing_time, __xlx_apatb_param_outgoing_meta);
    port4.buffer();
    port5.buffer();
    port6.buffer();
