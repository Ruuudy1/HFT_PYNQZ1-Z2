# 1 "microblaze_to_switch_src/MBtoSW.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "microblaze_to_switch_src/MBtoSW.cpp" 2
# 1 "microblaze_to_switch_src/MBtoSW.hpp" 1
...
# 2 "microblaze_to_switch_src/MBtoSW.hpp" 2
...
# 3 "microblaze_to_switch_src/MBtoSW.hpp" 2
...
__attribute__((sdx_kernel("MicroblazeToSwitch", 0))) void MicroblazeToSwitch(
...
# 2 "microblaze_to_switch_src/MBtoSW.cpp" 2
...
__attribute__((sdx_kernel("MicroblazeToSwitch", 0))) void MicroblazeToSwitch(
    ...
    stream<ap_uint<16> > &rxLengthMonitor)
{
#line 14 "C:/Users/ruuud/spring2025/cse145/AAAAHHHH/ECE1373_2016_hft_on_fpga/src/build_microblaze_to_switch_core.tcl"
#pragma HLSDIRECTIVE TOP name=MicroblazeToSwitch
# 12 "microblaze_to_switch_src/MBtoSW.cpp"
...
# 47 "microblaze_to_switch_src/MBtoSW.cpp"
    static ap_uint<32> rate_cnt = 0;
    const ap_uint<32> RATE_LIMIT = 4;
