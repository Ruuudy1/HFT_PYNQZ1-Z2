namespace eval ::optrace {
  variable script "C:/HFT_PYNQZ1-Z2/src/hft_proj_accelerator/hft_proj_accelerator.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/HFT_PYNQZ1-Z2/src/hft_proj_accelerator/hft_proj_accelerator.cache/wt [current_project]
  set_property parent.project_path C:/HFT_PYNQZ1-Z2/src/hft_proj_accelerator/hft_proj_accelerator.xpr [current_project]
  set_property ip_output_repo C:/HFT_PYNQZ1-Z2/src/hft_proj_accelerator/hft_proj_accelerator.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/HFT_PYNQZ1-Z2/src/hft_proj_accelerator/hft_proj_accelerator.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/HFT_PYNQZ1-Z2/src/hft_proj_accelerator/hft_proj_accelerator.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc c:/HFT_PYNQZ1-Z2/pynq_constraints.xdc
