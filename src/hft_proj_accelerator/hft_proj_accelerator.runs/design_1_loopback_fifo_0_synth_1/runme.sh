...
HD_PWD='C:/HFT_PYNQZ1-Z2/src/hft_proj_accelerator/hft_proj_accelerator.runs/design_1_loopback_fifo_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_loopback_fifo_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_loopback_fifo_0.tcl
