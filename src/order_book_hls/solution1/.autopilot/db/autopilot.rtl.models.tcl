set SynModuleInfo {
  {SRCNAME order_book_Pipeline_ASK_PUSH_LOOP2 MODELNAME order_book_Pipeline_ASK_PUSH_LOOP2 RTLNAME order_book_order_book_Pipeline_ASK_PUSH_LOOP2
    SUBMODULES {
      ...
      {MODELNAME order_book_sparsemux_7_2_8_1_1 RTLNAME order_book_sparsemux_7_2_8_1_1 BINDTYPE op TYPE sparsemux IMPL onehotencoding_realdef}
      ...
      {MODELNAME order_book_sparsemux_7_2_3_1_1 RTLNAME order_book_sparsemux_7_2_3_1_1 BINDTYPE op TYPE sparsemux IMPL onehotencoding_realdef}
      ...
      {MODELNAME order_book_sparsemux_7_2_16_1_1 RTLNAME order_book_sparsemux_7_2_16_1_1 BINDTYPE op TYPE sparsemux IMPL onehotencoding_realdef}
  ...
  {SRCNAME order_book MODELNAME order_book RTLNAME order_book IS_TOP 1
    SUBMODULES {
      {MODELNAME order_book_hole_lvl_bid_RAM_2P_LUTRAM_1R1W RTLNAME order_book_hole_lvl_bid_RAM_2P_LUTRAM_1R1W BINDTYPE storage TYPE ram_2p IMPL lutram LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME order_book_hole_idx_bid_RAM_2P_LUTRAM_1R1W RTLNAME order_book_hole_idx_bid_RAM_2P_LUTRAM_1R1W BINDTYPE storage TYPE ram_2p IMPL lutram LATENCY 2 ALLOW_PRAGMA 1}
      ...
      {MODELNAME order_book_order_book_stream_stream_stream_stream_stream_stream_stream_ap_uint_ap_u_95_Rbkb RTLNAME order_book_order_book_stream_stream_stream_stream_stream_stream_stream_ap_uint_ap_u_95_Rbkb BINDTYPE storage TYPE ram_1p IMPL bram LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME order_book_order_book_stream_stream_stream_stream_stream_stream_stream_ap_uint_ap_u_79_Rcud RTLNAME order_book_order_book_stream_stream_stream_stream_stream_stream_stream_ap_uint_ap_u_79_Rcud BINDTYPE storage TYPE ram_1p IMPL bram LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME order_book_order_book_stream_stream_stream_stream_stream_stream_stream_ap_uint_ap_u_383_eOg RTLNAME order_book_order_book_stream_stream_stream_stream_stream_stream_stream_ap_uint_ap_u_383_eOg BINDTYPE storage TYPE ram_1p IMPL bram LATENCY 2 ALLOW_PRAGMA 1}
