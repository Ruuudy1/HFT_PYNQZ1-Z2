...
// Command     : write_verilog -force -mode synth_stub -rename_top design_1_axi_dma_order_0 -prefix
//               design_1_axi_dma_order_0_ design_1_axi_dma_order_0_stub.v
...
/* synthesis syn_force_seq_prim="m_axi_s2mm_aclk" */;
  ...
  (* x_interface_info = "xilinx.com:signal:clock:1.0 M_AXI_MM2S_CLK CLK" *) (* x_interface_mode = "slave M_AXI_MM2S_CLK" *) (* x_interface_parameter = "XIL_INTERFACENAME M_AXI_MM2S_CLK, ASSOCIATED_BUSIF M_AXI_MM2S:M_AXIS_MM2S:M_AXIS_CNTRL, ASSOCIATED_RESET mm2s_prmry_reset_out_n:mm2s_cntrl_reset_out_n, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0" *) input m_axi_mm2s_aclk /* synthesis syn_isclock = 1 */;
