...
module design_1 (
  ...
  input user_sw_l;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.PS7_CLK_OUT CLK" *)
  (* X_INTERFACE_MODE = "master CLK.PS7_CLK_OUT" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.PS7_CLK_OUT, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0" *)
  output ps7_clk_out;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.PS7_RST_OUT RST" *)
  (* X_INTERFACE_MODE = "master RST.PS7_RST_OUT" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.PS7_RST_OUT, POLARITY ACTIVE_LOW, INSERT_VIP 0" *)
  output ps7_rst_out;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.PLATFORM_CLK CLK" *)
  (* X_INTERFACE_MODE = "master CLK.PLATFORM_CLK" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.PLATFORM_CLK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_RESET platform_rst, INSERT_VIP 0" *)
  output platform_clk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.PLATFORM_RST RST" *)
  (* X_INTERFACE_MODE = "master RST.PLATFORM_RST" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.PLATFORM_RST, POLARITY ACTIVE_LOW, INSERT_VIP 0" *)
  output platform_rst;
