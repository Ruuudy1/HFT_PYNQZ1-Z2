...
HD_PWD='C:/Users/ruuud/spring2025/cse145/WORKINGPROJECTIDEA/HFT_PYNQZ1-Z2/src/hft_proj/hft_proj.runs/design_1_axi_dma_meta_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_dma_meta_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_dma_meta_0.tcl
