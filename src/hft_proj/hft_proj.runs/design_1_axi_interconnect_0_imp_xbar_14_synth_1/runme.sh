...
HD_PWD='C:/HFT_PYNQZ1-Z2/src/hft_proj/hft_proj.runs/design_1_axi_interconnect_0_imp_xbar_14_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_interconnect_0_imp_xbar_14.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_interconnect_0_imp_xbar_14.tcl
